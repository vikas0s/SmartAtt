...
// Resolve paths relative to this file's location (repo root /api/)
const serverDir = path.resolve(__dirname, '../smart-attendance/server');

// Route imports
const authRoutes = require(path.join(serverDir, 'routes/authRoutes'));
const faceRoutes = require(path.join(serverDir, 'routes/faceRoutes'));
const sessionRoutes = require(path.join(serverDir, 'routes/sessionRoutes'));
const attendanceRoutes = require(path.join(serverDir, 'routes/attendanceRoutes'));
const errorHandler = require(path.join(serverDir, 'middleware/errorHandler'));
